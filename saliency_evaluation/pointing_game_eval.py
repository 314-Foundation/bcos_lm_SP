...
if __name__ == "__main__":
    parser = ArgumentParser(
        description="Evaluate the faithfulness for rationales using pointing game methods."
    )
    ...
    parser.add_argument(
        "--load_pointing_game_examples_path",
        type=str,
        default=None,
        help="Path to load pointing game examples",
    )
    parser.add_argument(
        "--save_pointing_game_examples_path",
        type=str,
        default=None,
        help="Path to save pointing game examples",
    )
    parser.add_argument(
        "--num_labels",
        type=int,
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="baseline_results/all_methods_1000_examples_256_pointing_game_results",
